...
//----------------------------- Bugdget management functions -----------------------------
    ...
    const createBudget$1 = async (type, budgetName) => {
        ...
        budgetsArray.value.push(newBudget);
...
return (_ctx, _cache) => {
  return (_openBlock$a(), _createElementBlock$a("div", {
    ...
    style: _normalizeStyle$1({ backgroundColor: selectColor.value || 'white' })
  }, [
    ...
    _createElementVNode$9("form", {
      ...
      _createElementVNode$9("div", _hoisted_1$9, [
        _cache[3] || (_cache[3] = _createElementVNode$9("label", { for: "title" }, "Nom du projet:", -1)),
      ...
      (_unref$7(typeOfBudget).length > 1)
        ? (_openBlock$a(), _createElementBlock$a("div", _hoisted_2$7, [
            _cache[4] || (_cache[4] = _createElementVNode$9("p", { for: "type" }, "Type de projet:", -1)),
...
const colorType = computed$5(() => { // Computed pour déterminer la couleur de fond en fonction du type de budget
  ...
  return typeInfo ? typeInfo.color : 'transparent' // Retourne la couleur correspondante ou transparent si le type n'est pas trouvé
});
...
const BudgetTitle = /*#__PURE__*/_export_sfc(_sfc_main$8, [['__scopeId',"data-v-0e38f8a4"]]);
...
computed$4(() => budgetStore.budgetsArray.slice(1)); // Computed pour obtenir la liste des budgets depuis le store, en excluant le budget par défaut (index 0)
...
return (_ctx, _cache) => {
  return (_openBlock$7(), _createElementBlock$7("nav", _hoisted_1$6, [
    ...
    (_openBlock$7(true), _createElementBlock$7(_Fragment$4, null, _renderList$4(_unref$5(budgetStore).budgetsArray.slice(1), (item) => {
    ...
    _cache[6] || (_cache[6] = _createElementVNode$6("p", { style: {"margin-top":"10px","color":"white"} }, "(Bientôt de nouvelles fonctionnalités disponibles)", -1))
  ]))
}
}

};
const sidebar = /*#__PURE__*/_export_sfc(_sfc_main$6, [['__scopeId',"data-v-a37d8f65"]]);
