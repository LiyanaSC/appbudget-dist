...
function _sfc_render(_ctx, _cache) {
  return (_openBlock$1(), _createElementBlock$1("div", _hoisted_1, _cache[0] || (_cache[0] = [
    _createElementVNode$1("p", null, "Je suis en cours de développement, je serai bientôt disponible.:)", -1)
  ])))
}
const BudgetView = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render],['__scopeId',"data-v-3388503a"]]);
