...
const _hoisted_6$5 = { class: "selection-style" };
            ...
            _createElementVNode$a("div", _hoisted_3$6, [
              (_openBlock$a(true), _createElementBlock$a(_Fragment$5, null, _renderList$5(_unref$8(typeOfBudget), (item) => {
                return (_openBlock$a(), _createElementBlock$a("div", {
                  ...
                  _createElementVNode$a("div", _hoisted_6$5, [
...
const CreateBudget = /*#__PURE__*/_export_sfc(_sfc_main$9, [['__scopeId',"data-v-ecc1b277"]]);
...
return (_ctx, _cache) => {
  return (_openBlock$7(), _createElementBlock$7("nav", _hoisted_1$6, [
    ...
    (_unref$6(budgetStore).creatingBudget)
      ? (_openBlock$7(), _createBlock$2(CreateBudget, { key: 1 }))
      : _createCommentVNode$5("", true),
    (_openBlock$7(), _createElementBlock$7("button", {
...
const _hoisted_6$3 = { value: "enfants" };
const _hoisted_7$3 = { value: "impots" };
...
return (_ctx, _cache) => {
  return (_openBlock$6(), _createElementBlock$6("div", _hoisted_1$5, [
    ...
    _withDirectives$3(_createElementVNode$6("select", {
      ...
      _withDirectives$3(_createElementVNode$6("option", _hoisted_6$3, "Enfants", 512), [
        [_vShow, !__props.incomes]
      ]),
      _withDirectives$3(_createElementVNode$6("option", _hoisted_7$3, "Impôts", 512), [
        [_vShow, !__props.incomes]
      ]),
...
const Card = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-9acaa86f"]]);
