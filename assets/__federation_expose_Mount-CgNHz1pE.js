...
return (_ctx, _cache) => {
  return (_openBlock$7(), _createElementBlock$7("nav", _hoisted_1$6, [
    ...
    _cache[4] || (_cache[4] = _createElementVNode$6("p", { style: {"margin-top":"10px","color":"white"} }, "(Bientôt de nouvelles fonctionnalités disponibles)", -1))
  ]))
}
}

};
const sidebar = /*#__PURE__*/_export_sfc(_sfc_main$6, [['__scopeId',"data-v-ba8aca3c"]]);
...
const {toDisplayString:_toDisplayString$1,createElementVNode:_createElementVNode$3,unref:_unref$2,renderList:_renderList$2,Fragment:_Fragment$2,openBlock:_openBlock$4,createElementBlock:_createElementBlock$4,vModelCheckbox:_vModelCheckbox,withDirectives:_withDirectives$2,vModelSelect:_vModelSelect$1,createCommentVNode:_createCommentVNode$2} = await importShared('vue');


const _hoisted_1$3 = { class: "card-box" };
const _hoisted_2$2 = { class: "header" };
const _hoisted_3$1 = ["src"];
const _hoisted_4$1 = { class: "transcations-displayed-text" };
const _hoisted_5$1 = { class: "transcations-displayed-span" };
const _hoisted_6$1 = { class: "transcations-displayed-span" };
const _hoisted_7$1 = ["onUpdate:modelValue", "onChange"];
const _hoisted_8$1 = ["value"];
const _hoisted_9$1 = { class: "ended-style" };
    ...
    _createElementVNode$3("ul", null, [
      (_openBlock$4(true), _createElementBlock$4(_Fragment$2, null, _renderList$2(transactionAssociated.value, (value) => {
        return (_openBlock$4(), _createElementBlock$4("li", {
          ...
          _createElementVNode$3("p", _hoisted_4$1, [
            _createElementVNode$3("span", _hoisted_5$1, _toDisplayString$1(value.named), 1),
            _createElementVNode$3("span", _hoisted_6$1, _toDisplayString$1(value.amount), 1)
          ]),
      ...
      ? _withDirectives$2((_openBlock$4(), _createElementBlock$4("select", {
          ...
          (_openBlock$4(true), _createElementBlock$4(_Fragment$2, null, _renderList$2(outcomes.value, (outcome) => {
            return (_openBlock$4(), _createElementBlock$4("option", {
              key: outcome._id,
              value: outcome._id
            }, _toDisplayString$1(outcome.named), 9, _hoisted_8$1))
          }), 128))
        ], 544)), [
...
const Card = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-d005d483"]]);
                  ...
                  (isOpen.value)
                    ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_16, [
                        _createElementVNode$1("ul", null, [
                          _cache[14] || (_cache[14] = _createStaticVNode("<div class=\"transactions-header\" data-v-4ef90aa8><p class=\"data-header\" data-v-4ef90aa8>Montant</p><p class=\"data-header\" data-v-4ef90aa8>Nom</p><p class=\"data-header\" data-v-4ef90aa8>Catégorie</p><div class=\"data-header-blank\" data-v-4ef90aa8></div></div>", 1)),
                        ...
                        _createElementVNode$1("form", _hoisted_17, [
                          ...
                          _withDirectives(_createElementVNode$1("select", {
                            ...
                            _createStaticVNode("<option value=\"salaire\" data-v-4ef90aa8>Salaire</option><option value=\"freelance\" data-v-4ef90aa8>Freelance</option><option value=\"entreprise\" data-v-4ef90aa8>Entreprise</option><option value=\"pension\" data-v-4ef90aa8>Pension</option><option value=\"allocations\" data-v-4ef90aa8>Allocations</option><option value=\"investissements\" data-v-4ef90aa8>Investissements</option><option value=\"autre\" data-v-4ef90aa8>Autre</option>", 7)
                          ]), 512), [
                ...
                _createElementVNode$1("div", _hoisted_19, [
                  ...
                  (isOpenOutcomes.value)
                    ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_23, [
                        _createElementVNode$1("ul", null, [
                          _cache[18] || (_cache[18] = _createStaticVNode("<div class=\"transactions-header-outcomes\" data-v-4ef90aa8><p class=\"data-header\" data-v-4ef90aa8>Montant</p><p class=\"data-header\" data-v-4ef90aa8>Nom</p><p class=\"data-header\" data-v-4ef90aa8>Catégorie</p><div class=\"data-header-blank\" data-v-4ef90aa8></div></div>", 1)),
                        ...
                        _createElementVNode$1("form", _hoisted_24, [
                          ...
                          _withDirectives(_createElementVNode$1("select", {
                            ...
                            _createStaticVNode("<option value=\"logement\" data-v-4ef90aa8>Logement</option><option value=\"courses\" data-v-4ef90aa8>Courses</option><option value=\"transport\" data-v-4ef90aa8>Transport</option><option value=\"santé\" data-v-4ef90aa8>Santé</option><option value=\"divertissement\" data-v-4ef90aa8>Divertissement</option><option value=\"enfants\" data-v-4ef90aa8>Enfants</option><option value=\"credits\" data-v-4ef90aa8>Crédits</option><option value=\"pro\" data-v-4ef90aa8>Pro</option><option value=\"perso\" data-v-4ef90aa8>Perso</option><option value=\"autre\" data-v-4ef90aa8>Autre</option>", 10)
                          ]), 512), [
...
const BudgetResults = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-4ef90aa8"]]);
