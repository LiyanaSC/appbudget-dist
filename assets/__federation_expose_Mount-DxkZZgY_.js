...
//----------------------------- Bugdget management functions -----------------------------
    ...
    const createBudget$1 = async (type, budgetName) => {
        ...
        if (type === 'simulation') {
            ...
            newBudget.transactions.forEach(transaction => delete transaction._id);
            newBudget.accounts.forEach(account => delete account._id);
        }
        if (type === 'budget') {
...
const sidebar = /*#__PURE__*/_export_sfc(_sfc_main$6, [['__scopeId',"data-v-1df426ea"]]);
